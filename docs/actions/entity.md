...
| **Имя**      | **Тип**                                                                                               | **Описание**    |
| ------------ | ----------------------------------------------------------------------------------------------------- | --------------- |
| `arms`       | перечисление:<br/>**ENABLE** - Включить<br/>**DISABLE** - Выключить<br/>**DONT_CHANGE** - Не изменять | Видимость рук   |
| `base_plate` | перечисление:<br/>**ENABLE** - Включить<br/>**DISABLE** - Выключить<br/>**DONT_CHANGE** - Не изменять | Видимость плиты |
...
| **Имя** | **Тип**                                                         | **Описание**   |
| ------- | --------------------------------------------------------------- | -------------- |
| `dance` | перечисление:<br/>**TRUE** - Включить<br/>**FALSE** - Выключить | Анимация танца |
...
| **Имя** | **Тип**                                                         | **Описание**    |
| ------- | --------------------------------------------------------------- | --------------- |
| `aware` | перечисление:<br/>**TRUE** - Включить<br/>**FALSE** - Выключить | Осведомлённость |
...
**Пример использования:**
```ts
entity::set_shulker_bullet_target("текст")
```
...
| **Имя**  | **Тип**                                                                                | **Описание**  |
| -------- | -------------------------------------------------------------------------------------- | ------------- |
| `hand`   | перечисление:<br/>**MAIN_HAND** - Основная рука<br/>**OFF_HAND** - Второстепенная рука | Тип руки      |
| `enable` | перечисление:<br/>**TRUE** - Включить<br/>**FALSE** - Выключить                        | Использование |
...
| **Имя**   | **Тип**                                                               | **Описание** |
| --------- | --------------------------------------------------------------------- | ------------ |
| `digging` | перечисление:<br/>**EMERGE** - undefined<br/>**DIG_DOWN** - undefined |              |
...
**Пример использования:**
```ts
entity::set_warden_anger_level("текст", 0)
```
...
**Пример использования:**
```ts
if (entity::in_area(location(0, 0, 0), location(0, 0, 0), "TRUE")) {
  player::message("Условие правдиво")
}
```
